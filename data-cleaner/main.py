...
if files:
    for file in files:
        ...
        selected_columns = st.multiselect(f"Select Coloumns - {file.name}", df.columns, default=df.columns)
        ...
        if st.button(f"⬇ Download {file.name} as {format_choices}"):
            ...
            if format_choices == "CSV":
                ...
                mime = "application/vnd.openxmlformats-offficedocument.spreadsheetml.sheet"
